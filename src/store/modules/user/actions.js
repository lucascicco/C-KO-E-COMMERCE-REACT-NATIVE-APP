...
export function RequestFavoriteItems(itemNumber, favorite){ //SAGA
    return {
...
export function addFavoriteItem(itemNumber){ //SAGA
    return {
...
export function removeFavoriteItem(itemNumber){ //SAGA
    return {
